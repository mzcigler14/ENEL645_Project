...
class efficientnet_b2_model(BaseModelInterface):
  ...
  def prepare_model(self, learning_rate, batch_size):
    ...
    model.classifier[1] = nn.Linear(in_features = 1408, out_features=7)
    ...
    data_loaders, dataset_sizes = self.data_handler.get_data(batch_size,InterpolationMode.BICUBIC, 288, 288)
