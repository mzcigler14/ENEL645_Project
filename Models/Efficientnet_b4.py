...
class efficientnet_b4_model(BaseModelInterface):
  ...
  def prepare_model(self, learning_rate, batch_size):
    ...
    model.classifier[1] = nn.Linear(in_features = 1792, out_features=7)
    ...
    data_loaders, dataset_sizes = self.data_handler.get_data(batch_size, InterpolationMode.BICUBIC, 384, 380)
